            ...
            if (axisDirection != Vector2.zero && targetPosition == transform.position)
            {
                if (Mathf.Abs(axisDirection.x) > Mathf.Abs(axisDirection.y))
                {
                    if (axisDirection.x > 0)
                    {
                        ...
                        {
                            if(hit2.collider.gameObject.GetComponent<Objeto>() && obj.inWall2 == false) hit2.transform.position = new Vector2(hit2.transform.position.x + pushDistance, hit2.transform.position.y);
                ...
                else
                {
                    if (axisDirection.y > 0)
                    {
                        ...
                        {
                            if (hit3.collider.gameObject.GetComponent<Objeto>() && obj.inWall3 == false) hit3.transform.position = new Vector2(hit3.transform.position.x, hit3.transform.position.y + pushDistance);
                    ...
                    else
                    {
                        ...
                        {
                            if (hit4.collider.gameObject.GetComponent<Objeto>() && obj.inWall4 == false) hit4.transform.position = new Vector2(hit4.transform.position.x, hit4.transform.position.y - pushDistance);
